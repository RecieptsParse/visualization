...
ner_eval_folder = "data/ner_evaluate" # used to grab the raw receipt texts
golden_annotations_path = "data/ner_evaluate/annotations/golden_annotations.json" # used to grab the "true" annotations
classified_annotations_path = "data/ner_evaluate/annotations/classified_ner_evaluate.json" # used to the grab the generated annotations
...
with open("overall_results.json", 'w') as json_file:
    json.dump(overall_results, json_file, indent=4)

with open("overall_results_per_tag.json", 'w') as json_file:
    json.dump(overall_results_per_tag, json_file, indent=4)
