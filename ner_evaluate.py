...
ner_eval_folder = "data" # used to grab the raw receipt texts
golden_annotations_path = "data/annotations/golden_annotations.json" # used to grab the "true" annotations
classified_annotations_path = "data/annotations/classified_ner_evaluate.json" # used to the grab the generated annotations
